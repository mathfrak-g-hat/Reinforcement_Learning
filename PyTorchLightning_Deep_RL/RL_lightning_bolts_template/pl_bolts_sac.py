...
https://github.com/Lightning-Universe/lightning-bolts/blob/0.5.0/pl_bolts/models/rl/sac_model.py

This version has the appropriate modifications for gym v0.26.2 (reset() and step())
"""
import argparse
