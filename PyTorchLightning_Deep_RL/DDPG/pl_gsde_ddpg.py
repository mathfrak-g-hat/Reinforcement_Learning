...
## gym v0.24.0 version
'''
    A slightly different implementation of DDPG with gSDE.
    During the training step, actions are sampled from 
    the induced action distribution instead of being
    computed after the sampling
'''
...
DEFAULT_POLICY_PARAMS = {"n_weight_resample_steps": 250,
                         ...
                         "log_sigma_init": -0.5,
                         "log_sigma_bound": 5.0,
                         "action_variance_min":1e-6,
                         "action_variance_max":1e4,
