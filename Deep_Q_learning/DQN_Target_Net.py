...
## Updated: 2022/06/05
## We implement a deep Q-learning agent with target network.
## Main algorithm from Mnih et al. 2015, "Human level control in deep reinforcement learning".
## Code inspired from implementations by P. Tabor and S. Ravichandiran.
## This version deals only with discrete action spaces, and was written with Gym's Lunar Lander in mind.
                ...
                for step t=1,...,T:
                    ...
                    for j=1,...,N:
                        if s_j is terminal:
                            ...
                            Set y_j = r_j + gamma*max_a Q^_tgt(s'_j,a)
...
###########################
# 22/06/05, AJ Zerouali
# Notes: Implemented with a target network. Several updates from "simple" version.
